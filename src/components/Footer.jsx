...
const Footer = () => {
	...
	return (
		<>
			<div id="contact" className="footer-container" ref={container}>
						...
						<div className="footer-right">
							<div className="footer-links">
								<ul className="link-group">
									<li className="link-header">NAVIGATION</li>
			...
			{openPopup && (
				<div className="newsletter-popup">
					<div className="popup-content">
						<h3>Welcome to CipherCell! 🔐</h3>
						<p>You've successfully joined our cybersecurity community.</p>
					</div>
				</div>
			)}
		</>
